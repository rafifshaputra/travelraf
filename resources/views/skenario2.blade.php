...
<div class="mobile" id="mobile" >
    ...
    <div class="contain" style="background-color:white;">
        ...
        <div class="rows" style="margin-top:1%;">
            ...
            <div onclick="openModals()"class="column" style=" position: relative;text-align: center;color: white;">
                <img id="imgcol5" onclick=""src="hrrestaurant2rs.png" alt="Forest" style="width:100%;height:150px;">
    ...
    <br>
     ...
     <!--INFORMASI HOTEL-->
     <div class="head" style="padding-left:3%;">
        <div style="font-size:42px"><b>Hotel Indah</b><img style="padding-left:1%;"src="bintang2.png" width="100px;height:100px;"><br></div><br>
      ...
      <p style="padding:15px;font-size:32px;" align="justify">
        <div class="row" style="padding-left:25px;" >
            ...
            <div class="column" align="center"  style="flex:20%;width:20%;" >
                <span><img src="wifi.png" width="100" height="100"></span><br><br>
            ...
            <div class="column"  align="center" style="flex:20%;width:20%;" >
                <span><img src="CAR-PARKING.png" width="100" height="100"></span><br><br>
            ...
            <div id="demo" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                  <div class="carousel-item active">
                    <img src="hrkamar1r.jpg" onclick="seeDetail();" alt="Los Angeles" width="1100" height="500" class="hover-shadow cursor">
                  </div>

                  <div class="carousel-item">
                    <img src="kamarmandi1r.jpg" onclick="seeDetail();"alt="Chicago" width="1100" height="500" class="hover-shadow cursor">
                  </div>
                </div>
        ...
        <div style="padding:2px;background-color:white;">
            <div class="rows" style="width:100%;padding-left:4%;"  >
                <div class="column4" style="font-size:34px;">
                    ...
                    <img src="https://imgur.com/K5sza9m.png" height="20px" width="20px"> Max 2 Tamu <br>
                    <img src="https://imgur.com/K5sza9m.png" height="20px" width="20px"> Single Bed<br>
                    <img src="https://imgur.com/K5sza9m.png" height="20px" width="20px"> 21.0 sqm<br>
                </div>
                <div class="column4" style="font-size:34px;">
        ...
        <div class="contain" style="font-size:36px;background-color:white">
            <div style="background-color:white;border-radius:15px;height:600px;">
                <div id="demos" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                      <div class="carousel-item active">
                        <img src="hrkamar1r.jpg" onclick="openModal()" alt="Los Angeles" width="1100" height="680" class="hover-shadow cursor">
                      </div>
                      <div class="carousel-item">
                        <img src="kamar3.jpg" onclick="openModal()"alt="Chicago" width="1100" height="680" class="hover-shadow cursor">
                      </div>

                      <div class="carousel-item">
                        <img src="hrrestaurant2r.jpg" onclick="openModal()"alt="Chicago" width="1100" height="680" class="hover-shadow cursor">
                      </div>
                      <div class="carousel-item">
                        <img src="kamarmandi1r.jpg" onclick="openModal()"alt="Chicago" width="1100" height="680" class="hover-shadow cursor">
                      </div>
                      <div class="carousel-item">
                        <img src="kamarmandi2r.jpg" onclick="openModal()"alt="Chicago" width="1100" height="680" class="hover-shadow cursor">
                      </div>
...
<div id="myModal" class="modal">
    ...
    <div class="modal-content" style="margin-top:5%;">
            <img id="gambarutama"
                width="100%" style="height:800px;" src="hrkamar1r.jpg">
            <div id="textnums"class="numbertext" style="font-size:24px;">1 / 5</div>
        ...
        <div class="rows">
            <div class="column">
                <img id="kmrbiasa"class="demo cursor" src="hrkamar1r.jpg" style="width:100%;height:200px;opacity:1;"   onclick="gantiGambar()" >
            </div>
            <div class="column" >
                <img id="kmrbiasa2"class="demo cursor" src="hrrestaurant2r.jpg"  style="width:100%;height:200px;"  onclick="gantiGambar2()" >
            </div>
            <div class="column" >
                <img id="kmrbiasa3"class="demo cursor" src="kamar3.jpg"  style="width:100%;height:200px;"  onclick="gantiGambar3()" >
            </div>
            <div class="column" >
                <img id="kmrmandi"class="demo cursor" src="kamarmandi1r.jpg" style="width:100%;height:200px;"  onclick="gantiGambar4()" >
            </div>
        </div>
        <div class="rows">
            <div class="column" >
                <img id="kmrmandi2"class="demo cursor" src="kamarmandi2r.jpg" style="width:100%;height:200px;"  onclick="gantiGambar5()" >
            </div>
        </div>
    </div>
</div>
...
<div id="myModals" class="modal">
    ...
    <div class="modal-content" style="margin-top:5%;">
        <div class="mySlides2">
            <div id="textnum"class="numbertext" style="font-size:28px;">1 / 8</div>

            <img id="gambarutamas"width="100%" style="height:800px;opacity:1;" src="hrlobi1.jpg">
        </div>


        <div class="caption-container">
            <p id="captions" style="color:white;font-size:24px;">Kamar Tidur</p>
        </div>
        ...
        <div class="rows">
            ...
            <div class="column" >
                <img id="kolamrenang1"class="demos cursor" src="hrkolamrenang1r.jpg" style="width:100%;height:200px;opacity:0.6;"  onclick="previewHome2()" >
            </div>
            <div class="column" >
                <img id="restaurant3"class="demos cursor" src="hrrestaurant3.jpg" style="width:100%;height:200px;opacity:0.6;"  onclick="previewHome3()" >
            </div>
            <div class="column" >
                <img id="restaurant2"class="demos cursor" src="hrrestaurant2.jpg" style="width:100%;height:200px;opacity:0.6;"  onclick="previewHome4()" >
            </div>
        </div>

        <div class="rows">
            <div class="column" >
                <img id="kamar1"class="demos cursor" src="hrkamar1r.jpg" style="width:100%;height:200px;opacity:0.6;"  onclick="previewHome5()" >
            </div>
            <div class="column" >
                <img id="kamar2"class="demos cursor" src="hrrestaurant2r.jpg" style="width:100%;height:200px;opacity:0.6;"  onclick="previewHome6()" >
            </div>
            <div class="column" >
                <img id="lobikamar"class="demos cursor" src="hrrestaurant1r.jpg" style="width:100%;height:200px;opacity:0.6;"  onclick="previewHome7()" >
            </div>
            <div class="column" >
                <img id="lobikamar2"class="demos cursor" src="lobikamar2.jpg" style="width:100%;height:200px;opacity:0.6;"  onclick="previewHome8()" >
            </div>
        </div>
