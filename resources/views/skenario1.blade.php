                ...
                <div id="demo" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                      <div class="carousel-item active">
                        <img src="hrkamar1r.jpg" onclick="openModal()" alt="Los Angeles" width="1100" height="500" class="hover-shadow cursor">>
                      </div>
                      <div class="carousel-item">
                        <img src="kamarmandi1r.jpg" onclick="openModal()"alt="Chicago" width="1100" height="500" class="hover-shadow cursor">>
                      </div>
...
<div id="myModal" class="modal">
    ...
    <div class="modal-content" style="margin-top:5%;">
        ...
        <div class="rows">
            ...
            <div class="column">
                <img id="kmrbiasa"class="demo cursor" src="hrkamar1r.jpg" style="width:100%;height:200px;opacity:1;"   onclick="gantiGambar1()" >
            </div>
            <div class="column" >
                <img id="kmrmandi"class="demo cursor" src="kamarmandi1r.jpg" style="width:100%;height:200px;"  onclick="gantiGambar()" >
            </div>
        </div>
    </div>
</div>
